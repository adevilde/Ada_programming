...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_interface" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4f3df18d#;
   pragma Export (C, u00001, "test_interfaceB");
   ...
   u00137 : constant Version_32 := 16#2c5cf816#;
   pragma Export (C, u00137, "ada__streams__stream_ioB");
   u00138 : constant Version_32 := 16#246a8ddb#;
   pragma Export (C, u00138, "ada__streams__stream_ioS");
   u00139 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00139, "system__communicationB");
   u00140 : constant Version_32 := 16#bbbac3cf#;
   ...
   u00143 : constant Version_32 := 16#36068beb#;
   ...
   u00146 : constant Version_32 := 16#0bd9e790#;
   ...
   u00148 : constant Version_32 := 16#b1d6282e#;
   ...
   u00150 : constant Version_32 := 16#1686bb90#;
   ...
   u00155 : constant Version_32 := 16#61e84971#;
   pragma Export (C, u00155, "system__fat_fltS");
   u00156 : constant Version_32 := 16#47da407c#;
   pragma Export (C, u00156, "system__fat_lfltS");
   u00157 : constant Version_32 := 16#3d0aee96#;
   pragma Export (C, u00157, "system__fat_llfS");
   u00158 : constant Version_32 := 16#7576898e#;
   pragma Export (C, u00158, "arbreB");
   u00159 : constant Version_32 := 16#16843d78#;
   pragma Export (C, u00159, "arbreS");
   u00160 : constant Version_32 := 16#c7880323#;
   pragma Export (C, u00160, "fichierB");
   u00161 : constant Version_32 := 16#1105b28e#;
   pragma Export (C, u00161, "fichierS");
   u00162 : constant Version_32 := 16#f883e66d#;
   pragma Export (C, u00162, "memoireB");
   u00163 : constant Version_32 := 16#b2be928b#;
   pragma Export (C, u00163, "memoireS");
   u00164 : constant Version_32 := 16#43f92802#;
   pragma Export (C, u00164, "codeB");
   u00165 : constant Version_32 := 16#612cb535#;
   pragma Export (C, u00165, "codeS");
   u00166 : constant Version_32 := 16#8c3b2645#;
   pragma Export (C, u00166, "interface_utilisateurB");
   u00167 : constant Version_32 := 16#834b7378#;
   pragma Export (C, u00167, "interface_utilisateurS");
   u00168 : constant Version_32 := 16#ab26c66f#;
   ...
   --  code%s
   --  code%b
   --  interface_utilisateur%s
   --  interface_utilisateur%b
   --  test_interface%b
