...
procedure compresser is
	...
	nom_fichier_init : Unbounded_String;
...
begin
	nom_fichier := To_String(nom_fichier_init);
	length := fichier_1.Taille(nom_fichier);
	nb_unique := code_0.nb_caractere_unique(nom_fichier);
	...
	Affichage(nom_fichier, tab_code, arbre, indent, Bavard);
